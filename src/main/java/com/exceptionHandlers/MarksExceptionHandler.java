...
@ControllerAdvice
public class MarksExceptionHandler extends ResponseEntityExceptionHandler {
	
	@Autowired
	private ResponseStructure<String> responseStructure;
	
	@ExceptionHandler(MarksException.class)
	public ResponseEntity<ResponseStructure<String>> marksExceptionHandler(MarksException exceptions){
